CREATE TABLE 'Buildings' (
        'PK_building_id' INT  NOT NULL   AUTO_INCREMENT,
        ...
        'visible_from_road' BOOLEAN,
        'interior_accessible' BOOLEAN,
        'interior_accessible_explanation' VARCHAR(255),
        ...
        FOREIGN KEY (FK_current_use) REFERENCES Building_Usages(usage),
        ...
        FOREIGN KEY (FK_researcher) REFERENCES Researchers(id),
);
...
CREATE TABLE 'Tours' (
    ...
    'order' (array of FKs to buildings)
    'status'
    'comment_count'
    'creator'
...
CREATE TABLE 'Owners' (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (type) REFERENCES Owner_Types(type)
);
